...
To stop this from happening, {{ site.bot_name }} was created to share a ban list of known fraudsters between a network of servers. Through the power of a dedicated Trust and Safety team, community reports and complete transparency in all actions, we've helped **{{ site.data.stats.installs }} servers** protect their members from scammers.
